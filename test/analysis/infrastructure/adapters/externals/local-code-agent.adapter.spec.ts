...
import { CodeAgentRequest } from '../../../../../src/analysis/application/DTOs/models/requests/code-agent-request-model.model';
...
describe('LocalCodeAnalysisAdapter', () => {
  ...
  const mockRequest = new CodeAgentRequest(mockAnalysisId);
