import { GitRequestMapper } from '../../../src/application/mappers/git-request-mapper.mapper';
...
describe('GitRequestMapper', () => {
  describe('toModel', () => {
    it('should return a GitRequestModel instance with all fields mapped', () => {
      const result = GitRequestMapper.toModel(mockBranch, mockRepoUrl, mockCommitHash, mockToken);
    ...
    it('should set commitHash to null when commitHash is omitted', () => {
      const result = GitRequestMapper.toModel(mockBranch, mockRepoUrl, undefined, mockToken);

      expect(result.commitHash).toBeNull();
    });

    it('should set personalAccessToken to null when token is omitted', () => {
      const result = GitRequestMapper.toModel(mockBranch, mockRepoUrl, mockCommitHash);
    ...
    it('should set both commitHash and personalAccessToken to null when both are omitted', () => {
      const result = GitRequestMapper.toModel(mockBranch, mockRepoUrl);
