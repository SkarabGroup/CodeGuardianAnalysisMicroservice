...
describe('GitAccessRequestModelMapper', () => {
  describe('toModel', () => {
    it('should return a GitAccessRequestModel instance with all fields mapped', () => {
    ...
    it('should set personalAccessToken to null when token is omitted', () => {
      const result = GitAccessRequestModelMapper.toModel(mockBranch, mockRepoUrl, mockCommitHash);
    ...
    it('should set both commitHash and personalAccessToken to null when both are omitted', () => {
      const result = GitAccessRequestModelMapper.toModel(mockBranch, mockRepoUrl);
